...
### 🔐 Tala – Full Stack Credential Manager

Secure MERN application for managing passwords, cards, notes, API keys, and sensitive data with authentication, search, sorting, and responsive UI.

### 🎭 DeepFake Video Detection System

AI-powered deepfake detection using Xception CNN + BiLSTM with Flask API and real-time video inference.
